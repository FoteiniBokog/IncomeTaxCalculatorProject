...
public class GraphicalInterface extends JFrame {
  ...
  public GraphicalInterface() {
    JButton selectTaxpayer = new JButton("Select"); //ADDED
    setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    setBounds(100, 100, 450, 500);
    contentPane = new JPanel();
    contentPane.setBackground(new Color(0, 0, 205)); //changed color to blue
    ...
    JButton Browse = new JButton("Browse");  //ADDED FOr the browse button
    taxRegistrationNumberPanel.add(TRN);
    taxRegistrationNumberPanel.add(taxRegistrationNumberField);
    taxRegistrationNumberPanel.add(Browse);//ADDED for the browse button
        ...
        if(e.getSource()== Browse){
          ...
          int response = fileChooser.showOpenDialog(null);//select file to open
              ...
              if (response == JFileChooser.APPROVE_OPTION){
                String a = fileChooser.getSelectedFile().getName(); //keep the name of the file
                String[] arrOfStr = a.split("_"); //split the name of the file to keep the number only
                taxRegistrationNumberField.setText(arrOfStr[0]); //take the first of the matrix which corresponds to th A.F.M
              }
        }
      }
    });
    ...
    taxRegisterNumberList.setBackground(new Color(51, 153, 255)); //changed the color to light blue
    ...
    txtTaxRegistrationNumber.setBackground(new Color(51, 153, 255)); ///changed color to light blue
